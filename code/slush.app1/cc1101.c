...
void RegConfigSettings(void)
{
    ...
    SpiWriteReg(CC1101_PKTCTRL0, 0x05);		//whitening off;CRC Enable��variable length packets set by PKTLEN reg
    SpiWriteReg(CC1101_ADDR,     0x00);		//address used for packet filtration.
    SpiWriteReg(CC1101_PKTLEN,   0x3D); 	//0x3D = 61 uint8_ts max length, 0x00 = 0 to enable variable Length
}
